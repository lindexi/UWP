...
namespace Lindexi.Src.Core.Text;
...
public class ArrayPoolStringBuilder
{
    // Implementation note:
    ...
    private Span<char> _chars => _arrayToReturnToPool;
    ...
    public ArrayPoolStringBuilder(int literalLength, int formattedCount)
    {
        _provider = null;
    ...
    /// <remarks>This is intended to be called only by compiler-generated code. Arguments are not validated as they'd otherwise be for members intended to be used directly.</remarks>
    public ArrayPoolStringBuilder(int literalLength, int formattedCount, IFormatProvider? provider)
    {
        _provider = provider;
        _arrayToReturnToPool = ArrayPool<char>.Shared.Rent(GetDefaultLength(literalLength, formattedCount));
        _pos = 0;
    ...
    ///// <remarks>This is intended to be called only by compiler-generated code. Arguments are not validated as they'd otherwise be for members intended to be used directly.</remarks>
    //public ArrayPoolStringBuilder(int literalLength, int formattedCount, IFormatProvider? provider, Span<char> initialBuffer)
    //{
    //    _provider = provider;
    ...
    private void GrowCore(uint requiredMinCapacity)
    {
        ...
        uint newCapacity = Math.Max(requiredMinCapacity, Math.Min((uint) _chars.Length * 2, int.MaxValue));
