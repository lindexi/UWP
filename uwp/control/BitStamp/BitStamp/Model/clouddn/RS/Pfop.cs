...
namespace Qiniu.RS
{
    ...
    public class Pfop : QiniuAuthClient
    {
		...
		/// <returns></returns>
		public async System.Threading.Tasks.Task<string> Do(EntryPath entry, string[] fops, Uri notifyURL, string pipleline, int force = 0)
		{
			...
			CallRet ret = await CallWithBinary(Config.API_HOST + "/pfop/", "application/x-www-form-urlencoded", StreamEx.ToStream(body), body.Length);
		...
		public async System.Threading.Tasks.Task<string> QueryPfopStatus(string persistentId)
		{
