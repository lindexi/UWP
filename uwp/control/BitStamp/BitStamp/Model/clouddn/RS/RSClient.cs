...
namespace Qiniu.RS
{
	...
	public class RSClient : QiniuAuthClient
	{
		...
		/// <returns></returns>
		private async System.Threading.Tasks.Task<CallRet> op(FileHandle op, EntryPath scope)
		{
		...
		/// <returns></returns>
		private async System.Threading.Tasks.Task<CallRet> op2(FileHandle op, EntryPathPair pair)
		{
		...
		private async System.Threading.Tasks.Task<CallRet> opFetch(FileHandle op, string fromUrl, EntryPath entryPath)
		{
		...
		/// <returns>见<see cref="CallRet">CallRet</see></returns>
		public async System.Threading.Tasks.Task<CallRet> Fetch(string fromUrl, EntryPath entryPath)
		{
		...
		private async System.Threading.Tasks.Task<CallRet> batch(string requestBody)
		{
			return await CallWithBinary(Conf.Config.RS_HOST + "/batch", "application/x-www-form-urlencoded", StreamEx.ToStream(requestBody), requestBody.Length);
		}
		...
		/// <returns></returns>
		public async System.Threading.Tasks.Task<List<BatchRetItem>> BatchStat(EntryPath[] keys)
		{
		...
		public async System.Threading.Tasks.Task<CallRet> BatchMove(EntryPathPair[] entryPathPairs)
		{
		...
		public async System.Threading.Tasks.Task<CallRet> BatchCopy(EntryPathPair[] entryPathPari)
		{
		...
		/// <param name="keys"></param>
		/// <returns></returns>
		public async System.Threading.Tasks.Task<CallRet> BatchDelete(EntryPath[] keys)
		{
