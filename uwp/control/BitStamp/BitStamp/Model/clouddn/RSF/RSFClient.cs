...
namespace Qiniu.RSF
{
	...
	{        
		...
		/// Limit.
		/// </param>
		public async System.Threading.Tasks.Task<DumpRet> ListPrefix(string bucketName, string prefix = "", string markerIn = "", int limit = 0)
		{
		...
		/// </example>
		/// </summary>
		public async System.Threading.Tasks.Task<List<DumpItem>> Next()
		{
			if (end)
			{
				return null;
			...
			try
			{
				DumpRet ret = await ListPrefix(this.bucketName, this.prefix, this.marker, this.limit);
